                    ...
                    <div style=" padding: 40px">
                        <form action="{{ action('ProfileController@updateProfile') }}" method="POST" role="form" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-3">
                                        <h6 class="col-form-label text-md-right" style="vertical-align: center">{{__('messages.editemail')}}</h6>
                                    </div>
                                    <div class="col-md-8">
                                        <input id="email" value="{{$email}}" type="text" class="form-control  @error('email') is-invalid @enderror" name="email" required autocomplete="email" autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input id="profile_picture" type="file"  class="form-control border-0 @error('profile_picture') is-invalid @enderror" value="{{ old('profile_picture') }}" name="profile_picture" />
